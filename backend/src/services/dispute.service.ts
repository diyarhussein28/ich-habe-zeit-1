...
export async function resolveDispute(data: {
  ...
  return prisma.$transaction(async (tx) => {
    ...
    let newOrderStatus: 'RELEASED' | 'REFUNDED' | 'PARTIALLY_RELEASED' = 'RELEASED'
    let releasedAmount = order.netProviderAmount
    ...
    switch (data.outcome) {
      case 'FULL_RELEASE':
        ...
        // TODO: Mangopay transfer to provider
        break
      case 'FULL_REFUND':
        newOrderStatus = 'REFUNDED'
        releasedAmount = 0
        refundedAmount = order.grossAmount
        // TODO: Mangopay refund to customer
        break
      case 'PARTIAL_RELEASE':
        ...
        // TODO: Mangopay partial split
        break
      case 'REWORK_AGREEMENT':
        // Funds remain frozen — order goes back to IN_PROGRESS
